...
public class Constants {
	...
	public static final long EMPLOYER_ROLE = 2;
	public static final long CANDIDATE_ROLE = 3;
	
	public static final String SUCCESS = "SUCCESS";
	public static final String LINE_SEPERATOR = "\n";
	
	public static final String[] JOB_TYPES = {"Full Time", "Part Time"};
	public static final String[] SALARY_TYPES = {"Per Year", "Per Month", "Per Day", "Per Hour"};
